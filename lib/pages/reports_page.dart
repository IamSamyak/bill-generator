...
class ReportsPage extends StatelessWidget {
  ...
  const ReportsPage({super.key, required this.initialBills, required this.onBack});
  ...
  Widget build(BuildContext context) {
    ...
    double barWidth = months.length > 1 ? (300 / months.length) : 30;
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Monthly Revenue Reports"),
        leading: IconButton(
